...
//            SystemClock.sleep(3000);
    ...
    private String saveCrashInfoFile(Throwable ex) throws Exception {
        ...
        try {
            ...
            sb.append("\r\n" + date + "\n");
            for (Map.Entry<String, String> entry : infos.entrySet()) {///遍历输出设备信息
            ...
            while (cause != null) {
                cause.printStackTrace(printWriter);//把异常栈信息输出到PrintWriter中
                printWriter.append("\r\n");//换行
...
//        FileUtil.delete(Constants.LOG_DIR, new FilenameFilter() {
//
//            @Override
